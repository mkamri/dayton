...
document.addEventListener('click', function(e) {
	if (e.target == daiSection || e.target == daiSection.firstElementChild) {
	...
	} else if (e.target == airforceSection || e.target == airforceSection.firstElementChild) {
	...
	} else if (e.target == boonshoftSection || e.target == boonshoftSection.firstElementChild) {
